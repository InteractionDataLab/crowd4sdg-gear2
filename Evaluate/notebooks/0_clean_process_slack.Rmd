...
path = "../data/Crowd4SDG Slack export Oct 6 2021 - Feb 9 2022" # Path to the root folder with the API   extracted Slack data
...
users_df = users_df %>% select("id", "real_name", "tz", "deleted", "is_admin", "is_owner", "is_primary_owner", "is_restricted", "is_ultra_restricted", "is_bot", "is_app_user", "is_invited_user", "updated", title = "profile.title", image = "profile.image_512", email = "profile.email")
